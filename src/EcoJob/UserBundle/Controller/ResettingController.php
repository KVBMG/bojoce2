...
class ResettingController extends Controller
{
    ...
    public function checkEmailAction(Request $request)
    {
        ...
        if ($user == null) {
            ...
            $error = sprintf('L\'utilisateur avec l\'adresse e-mail ou nom d\'utilisateur "%s" n\'existe pas', $username);

            return $this->render('@FOSUser/Resetting/request.html.twig',array('error' => $error));
            
            //return new RedirectResponse($this->generateUrl('fos_user_resetting_request',array('error' => $error)));
        }

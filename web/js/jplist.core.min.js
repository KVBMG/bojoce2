/**
* jPList - jQuery Data Grid Controls 5.2.0.278 - http://jplist.com 
...
function(a,e,b){l(this,a,e,b)};jQuery.fn.jplist.Dataitems.prototype.addDataItems=function(a,e,b){m(this,a,0,e,b);h(this)};jQuery.fn.jplist.Dataitems.prototype.delDataitem=function(a){f(this,a)};jQuery.fn.jplist.Dataitems.prototype.delDataitems=function(a){k(this,a)};jQuery.fn.jplist.Dataitems.prototype.indexOf=function(a){return g(this,a)};jQuery.fn.jplist.Dataitems.prototype.dataviewToString=function(){var a,e="",b;for(b=0;b<this.dataview.length;b++)a=this.dataview[b],e+=a.html;return e}})();(function(){jQuery.fn.jplist.PaginationService=function(d,b,c){c=Number(c);isNaN(c)&&(c=0);c=this.itemsNumber=c;jQuery.isNumeric(b)?(b=Number(b),isNaN(b)&&(b=c)):b=c;this.itemsOnPage=b;b=(b=this.itemsOnPage)?Math.ceil(this.itemsNumber/b):0;b=this.pagesNumber=b;d=Number(d);isNaN(d)&&(d=0);d>b-1&&(d=0);this.currentPage=d;this.start=this.currentPage*this.itemsOnPage;d=this.itemsNumber;b=this.start+this.itemsOnPage;b>d&&(b=d);this.end=b;d=this.currentPage;this.prevPage=0>=d?0:d-1;d=this.currentPage;b=

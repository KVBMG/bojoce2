...
INSERT INTO `cu_vi` VALUES (2,'Adnan','Mohammed',201245850,'Teste 12','59dedaf0a8e81.jpg','2017-10-12 05:01:04','',0,0,'',0,1),(4,'Adnan','Mohammed',32158556,'ingénieur en informatique','59f57f619b348.gif','2017-11-01 19:51:34','Informaticien',45.764043,4.835658999999964,'Lyon, France',1,0);
...
INSERT INTO `cu_vi_contrat_categorie` VALUES (4,1),(4,2);
...
INSERT INTO `offre` VALUES (3,1,2,1,'Java','What is Java ?',1,48.85661400000001,2.3522219000000177,'Paris, France','2017-10-17 15:19:58',2,'2018-12-02 23:50:20',1,1,1,NULL),(4,2,2,1,'How to keep your translations well organized in Symfony2[edited]','We are working at the moment on a big internationalized project, and we have consequently many translations in our application. These translations are dispatched in many bundles (7 for now) and are used throughout the application. At the begining of the d',1,48.856614,2.3522219,'Paris, France','2017-10-17 15:19:58',2,'2017-10-22 13:40:29',0,1,1,NULL),(5,1,2,1,'Efficient Elasticsearch indexing configuration','This post is about elasticsearch which is a great search engine.            The biggest difficulty we meet is that we do not know how to configure it to have relevant search results. Another difficulty is (sorry to say that), the documentation is not ve',1,48.8657844,2.307314099999985,'Champs-Élysées, Pari','2017-10-17 15:19:58',2,NULL,0,NULL,1,NULL),(12,1,2,1,'Configure WSSE on Symfony2 with FOSRestBundle','The client–server communication is further constrained by no client context being stored on the server between requests. Each request from any client contains all of the information necessary to service the request, and any session state is held in the cl',1,45.764043,4.835658999999964,'Lyon, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(13,2,2,1,'DateTimePicker field type with Symfony2 and jQuery','In this third post, we’ll explain how to create a great custom field type that uses jQuery DatePicker to handle date input, and then, how to extend it to create a datetime field type. And the best? The datepicker is localized according to the user’s local',1,43.296482,5.369779999999992,'Marseille, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(14,1,2,1,'Currency Change rates update on Symfony2 using openexchangerates.org API','In this post, we’ll explain how to create and maintain a database with currencies and change rates.            In order to update our changes rates, we will user openexchangerates.org solution. (Exists as free, premium and pro)',1,44.837789,-0.5791799999999512,'Bordeaux, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(15,1,2,1,'Create a breadcrumb menu with KnpMenuBundle','In this first post, I’ll explain how to make a breadcrumb menu with the great KnpMenuBundle. The documentation explains the basics and how to make a common menu, but a breadcrumb menu has a particular behaviour.',1,43.604652,1.4442090000000007,'Toulouse, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(16,2,2,1,'Create new log file/channel for a Symfony2 Service (With monolog)','In this article about WSSE and Rest, we describe how to create a new log file/channel with monolog in Symfony2',1,47.218371,-1.553621000000021,'Nantes, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(17,2,2,1,'Create a custom form theme block with Twig','I wanted to use the following block. As you see, in addition to the specific p element, the div and their specific classes, the big difference with the native Twig form_row method is that the radio labels are not in a label tag (but there is a label tag f',1,48.57340529999999,7.752111300000024,'Strasbourg, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(18,2,2,1,'Export datas to a csv file with Symfony2','I recently had to export a huge set of data to a csv file. This is easy and fast to do if you don’t care about memory and User Experience. I wanted the memory consumption does not increase with the volume of data.            I got inspiration from this',1,43.7101728,7.261953199999994,'Nice, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(19,2,2,1,'Install Rest in Symfony2 existing application','As we needed a connection between a Symfony2 web application and an Android application, we had to learn and understand how to make this in a simple and secured way, based on our existing entities.            We chose WSSE for security access, FOSRestBu',1,50.62924999999999,3.057256000000052,'Lille, France','2017-10-17 15:19:58',2,NULL,0,1,1,NULL),(20,2,2,1,'How to use WSSE in Android app','How to use WSSE in Android app',1,43.610769,3.8767159999999876,'Montpellier, France','2017-10-17 15:19:58',2,'2017-09-30 17:35:57',0,1,1,NULL),(22,1,2,1,'Fanampiny','Ajout simple',1,48.84430380000001,2.374377299999992,'Paris Gare de Lyon, ','2017-10-17 15:19:58',2,NULL,0,NULL,1,NULL),(28,1,2,1,'U','U',1,98798798798798,98798798798798,'LKJLKJLKJLKJ','2017-10-17 15:19:58',1,'2017-09-30 18:18:38',1,1,1,NULL),(29,1,2,1,'Offre lyon','essai',1,45.764043,4.835658999999964,'Lyon, France','2017-10-17 15:19:58',1,'2017-10-09 03:00:18',0,1,1,NULL),(30,1,2,1,'Essai','Alerte mail',1,44.562918,-0.8655079999999771,'Paris, Salles, Franc','2017-10-18 03:25:30',1,'2017-10-18 03:26:50',0,1,1,NULL),(31,1,2,1,'Essai','sdfsfsdfsdfsd mail',1,43.4941437,5.893280900000036,'Paris, Seillons-Sour','2017-10-18 03:33:00',2,'2017-10-18 03:48:38',0,1,1,NULL),(32,1,2,1,'Test ajout','tttt',0,45.764043,4.835658999999964,'Lyon, France','2017-10-25 17:55:10',1,NULL,0,1,1,NULL),(33,1,2,1,'Délai','test',1,45.764043,4.835658999999964,'Lyon, France','2017-10-25 22:00:06',1,'2017-10-25 22:01:07',0,2,1,NULL);
...
INSERT INTO `utilisateur` VALUES (1,1,4,'Adnan','adnan','norazafindrakoto@gmail.com','norazafindrakoto@gmail.com',1,'ui.sqnKx8BESFlgzFoJfGU9XqxcGSTfN7AUtToq5R0w','TJPWDn7LzBWHCTKmmtKhiEkW3GtVdurVQGvdkkkMGjPg59vwGXVNC41crrF1/KAda14HrImTgACMRlKDKKsc6Q==','2017-11-01 19:34:34',NULL,NULL,'a:2:{i:0;s:13:\"ROLE_CANDIDAT\";i:1;s:10:\"ROLE_ADMIN\";}','2017-10-28 11:09:13',1),(2,2,NULL,'Nomena','nomena','fidiarilantov@yahoo.com','fidiarilantov@yahoo.com',1,'jVd/xA3TXh6kEl9HrmnjODaFpT8I.BtcHaIuo5D0DuQ','erHbfeiVuCy69h6bl5RYBbK0Nx4KQYlbiyvrAHDOUg0XKD0XiPfftpYuMQGdZ/Ie2jbl1WbwaJE5iNQoqNg0rg==','2017-11-01 19:51:15',NULL,NULL,'a:1:{i:0;s:14:\"ROLE_RECRUTEUR\";}','2017-10-28 11:09:17',NULL),(3,1,NULL,'Administrateur','administrateur','infermedica@gmail.com','infermedica@gmail.com',1,'SF7zZF7xDy08DYppAafw.0ZqWM4Ru3Eu5n4zsAcwds4','+d+azJGiwgUKjxBCMC9L6u9TZBh5D0NAsAGbvidDgpSpqMq6OOraeGfoWhKAZKJalCcz9hpqXI63VplmjMmQsQ==','2017-11-01 18:48:46',NULL,NULL,'a:1:{i:0;s:16:\"ROLE_SUPER_ADMIN\";}','2017-09-15 04:06:42',NULL),(4,1,2,'mohammed','mohammed','adnanmohammed769@yahoo.com','adnanmohammed769@yahoo.com',1,'Uxg4x8Cpe57YgEn55cSjbRWS9xqP0q.6i.WNhYMeQkk','NGAumjnpdG8vwVd8VQB1Kj6ys2CDCwx0IsCA+Nu5kr2NQcfeZfR3mCSk7BSBYuXAF8k50bfJvuV1cR4riP8A6g==','2017-10-12 05:55:21',NULL,NULL,'a:1:{i:0;s:13:\"ROLE_CANDIDAT\";}','2017-10-12 04:46:49',NULL);
...
-- Dump completed on 2017-11-02 13:06:05
